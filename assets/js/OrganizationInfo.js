...
import {
    ...
    getEvents,
    fetchRepos
} from 'actions/organizationInfoActions.js'
...
class OrganizationInfo extends React.Component {
    ...
    render() {
        ...
        const mappedMembers = members.map(member =>
            <
            li class = "collection-item avatar col m2 s12"
            key = {
                member.id
            }
            style = {
            ...
            a href = "#!"
            class = "secondary-content" > < i class = "material-icons" > < /i></a >
            <
            /li>
        )
        const mappedEvents = events.map(event =>
            ...
            parole = {
                event.type == 'IssuesEvent' ? event.payload.action : ''
            }
            />
        )
